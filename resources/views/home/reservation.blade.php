        ...
        <div class="w-full xl:w-1/2 h-full p-6 xl:pr-0">
            <div class="relative overflow-hidden aspect-square md:aspect-video xl:aspect-auto xl:h-full">
                <div class="h-full relative">
                    <img src="{{ asset('assets/img/reservation.webp') }}" class="w-full h-full block object-cover rounded-2xl" />
                    <div
                        class="absolute container bottom-8 left-1/2 -translate-x-1/2 xl:translate-x-0 xl:bottom-10 xl:left-10">
                        <p
                            class="text-[56px] leading-none text-center xl:text-left md:text-7xl lg:text-8xl xl:text-[112px] text-light uppercase font-forum">
                            {{ $title }}
                        </p>
                    </div>
                </div>
                  ...
                  <div class="pt-10">
                      <div class="mb-8 w-full max-w-2xl mx-auto">
                          ...
                          <div class="mt-8">
                              ...
                              <livewire:home.reservation.index />
                          </div>
                      </div>
