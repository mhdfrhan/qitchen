...
<nav x-data="{ open: false }" class="bg-neutral-900 border border-borderColor z-40 relative rounded-2xl xl:hidden mb-8 print:hidden">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-lg border bg-[#111116] border-borderColor text-light focus:outline-none focus:bg-neutral-800 transition duration-150 ease-in-out">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-borderColor">
            <div class="px-4">
                <div class="font-medium text-base text-light" x-data="{{ json_encode(['name' => auth()->user()->name]) }}" x-text="name"
                    x-on:profile-updated.window="name = $event.detail.name"></div>
